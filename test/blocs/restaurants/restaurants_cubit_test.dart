...
void main() {
  group('RestaurantsCubit', () {
    ...
    group('getRestaurants()', () {
      ...
      List<RestaurantUi> mockRestaurantsUi() =>
          mockRestaurants().map((r) => RestaurantUi(restaurant: r)).toList();
      ...
      blocTest<RestaurantsCubit, RestaurantsState>(
        'when it loads more restaurants',
        build: () {
          when(callingGetRestaurants).thenAnswer((_) async {
            const response = RestaurantQueryResult(
              total: 100,
              restaurants: [Restaurant(id: '20')],
            );
        ...
        expect: () => [
          ...
          RestaurantsState.initial().copyWith(
            ...
            hasMore: false,
            restaurants: [
              ...mockRestaurants().map((r) => RestaurantUi(restaurant: r)),
              ...const [RestaurantUi(restaurant: Restaurant(id: '20'))],
            ],
          ),
        ],
        verify: (_) {
